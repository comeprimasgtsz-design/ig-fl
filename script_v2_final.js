...
// Configuração dos sites com seletores atualizados e validados (Julho/2026)
const sitesConfig = [
    { 
        name: "birtakipci", 
        ...
        startButtonText: ["Takibi Başlat", "Gönderimi Başlat", "Start", "START"],
        loginType: "standard"
    },
    { 
        name: "takipcimax", 
...
class MultiSiteAutomation {
    ...
    async initBrowser() {
        ...
        this.browser = await puppeteer.launch({
            ...browserOptions,
            protocolTimeout: 120000 // Aumentado para 2 minutos para sites lentos
        });
        this.page = await this.browser.newPage();
        await this.page.setViewport({ width: 1366, height: 768 });
        
        // Configurar timeout global
        this.page.setDefaultTimeout(60000); // Aumentado para 60s
        this.page.setDefaultNavigationTimeout(0); // Sem limite para navegação inicial
    }
    ...
    async login(siteConfig) {
        try {
            ...
            // Aguardar o seletor de usuário aparecer
            ...
            if (siteConfig.loginType === "ajax" || siteConfig.loginButtonId) {
                ...
                // Tentar submeter via formulário ou botão de texto
            ...
            // Aguardar um pouco para processar o login
            await new Promise(resolve => setTimeout(resolve, 8000));

            // Tentar forçar a navegação para a página de envio, caso o login tenha funcionado em segundo plano
    ...
    async sendFollowers(siteConfig, targetUsername, followerCount = 500) {
        try {
            ...
            // CORREÇÃO: Aguardar o campo de usuário alvo com mais tolerância
            ...
            // CORREÇÃO: Clique seguro no botão de busca
            ...
            // CORREÇÃO: Clique seguro no botão de início
            ...
            if (startClicked) {
                ...
                // Aguardar 15 segundos sem travar o script se o site demorar
    ...
    async run(targetUsername, followerCount) {
        await this.initBrowser();
        for (const site of this.sitesConfig) {
            await this.processSite(site, targetUsername, followerCount);
            await new Promise(r => setTimeout(r, 5000)); // Pequena pausa entre sites
        }
